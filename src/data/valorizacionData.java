...
public class valorizacionData {
    ...
    public List<valorizacion> ListTodoHastaIdvalDeIdobraASC(int idobra, int idval) {
        List<valorizacion> lista = new ArrayList<valorizacion>();
        try {
            conexion dbm = new conexion();
            Connection con = dbm.getConnection();
    ...
    public valorizacion buscarIdobraASCmenorIdvalLimit(int idobra, int idval) {//buscar val anterior
        valorizacion p = null;
        try {
            conexion dbm = new conexion();
