...
public class C1_presupuestos {
    ...
    public C1_presupuestos(int idps, int idova, int idfm, String idpar, String descripcion, String unidad, double metrado, double pre_unit, double presupuesto, String idpardep) {
        this.idps = idps;
        this.idova = idova;
        this.idfm = idfm;
        this.idpar = idpar;
