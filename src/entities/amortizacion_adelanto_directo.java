...
public class amortizacion_adelanto_directo {
    ...
    public amortizacion_adelanto_directo(int idaad, int idfm, int idval, int nro_valorizacion, String mes_anio, double monto_metrado, double amortizacion,
            double amortizacion_acumulada, double saldo_amortizar, double amortizacion_real, double amortizacion_acumulada_real, int mes_activo) {
        this.idaad = idaad;
        this.idfm = idfm;
    ...
    /**
     * @return the nro_valorizacion 158
     */
    ...
    /**
     * @param amortizacion_acumulada_real the amortizacion_acumulada_real to set
     */
