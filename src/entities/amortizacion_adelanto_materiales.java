...
double coeficiente_incidencia, double indice_mes_base, double
indice_mes_adelanto, double indice_mes_reajuste, double mv_ci, double
amortizacion_calculada, double adelanto, double amortizacion_real, double
saldo_amortizar, int mes_activo) {
 this.idaam = idaam;
 this.idfm = idfm;
 this.idval = idval;
 this.idpsm = idpsm;
