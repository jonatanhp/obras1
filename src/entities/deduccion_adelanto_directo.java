...
public class deduccion_adelanto_directo {
    ...
    public deduccion_adelanto_directo(int iddad, int idmcr, int idval, int nro_valorizacion, String mes_anio, double monto_metrado, double adelanto,
            double monto_contrato, double kr, double ka, double deduccion, String mes_anio_deducido, int mes_activo) {
        this.iddad = iddad;
        this.idmcr = idmcr;
        this.idval = idval;
    ...
    /**
     * @param mes_anio_deducido the mes_anio_deducido to set 150
     */
