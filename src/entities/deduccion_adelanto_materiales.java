...
public class deduccion_adelanto_materiales {
    ...
    public deduccion_adelanto_materiales(int iddam, int idmim, int idval, int idpsm, int nro_valorizacion, String mes_anio, double monto_metrado, double coeficiente_incidencia, double indice_mes_base, double indice_mes_adelanto,
            double indice_mes_reajuste, double adelanto, double monto_maximo_utilizado,
            double adelanto_deducible, double saldo_adelanto, double deduccion, String mes_anio_pago, int mes_activo) {
        this.iddam = iddam;
        this.idmim = idmim;
        this.idval = idval;
        this.idpsm = idpsm;
