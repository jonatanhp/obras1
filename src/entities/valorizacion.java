...
public class valorizacion {
 ...
 public valorizacion(int idval, int idobra, int nro_valorizacion, String
mes_pertenece, Date fecha_registro, int estado_proceso_1, int
estado_proceso_2, boolean estado) {
 this.idval = idval;
 ...
 */
 ...
 /**
 * @param estado_proceso_1 the estado_proceso_1 to set
146
 */
